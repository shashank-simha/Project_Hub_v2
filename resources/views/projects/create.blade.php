        ...
        <div class="container-contact100">
            <div class="wrap-contact100">
                <div class="contact100-form-title" style="background-image: url({{ asset('images/bg-01.jpg') }});">
                    <span class="contact100-form-title-1">Add a Project</span>
                    <span class="contact100-form-title-2">Feel free to create your project below!</span>
                </div>

                <form class="contact100-form validate-form"method="post" action="{{ route('projects.store') }}">
                    {{csrf_field()}}
